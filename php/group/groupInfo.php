...
try{
  ...
  // echo $grouparea;
  //留言
  $sql = "select GROUP_MES_NO, GROUP_MES_MEMNO, MEM_NICKNAME, MEM_IMG, GROUP_MES_TIME , GROUP_MES_CONTENT from GROUP_MES a JOIN member b on a.GROUP_MES_MEMNO = b.MEMNO where GROUP_MES_GROUPNO = $GROUP_NO;";
  $groupRows = $pdo->query($sql);
